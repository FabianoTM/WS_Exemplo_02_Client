...
<jsp:useBean id="samplePrimeiroPortTypeProxyid" scope="session" class="br.com.ftm.exemplos.PrimeiroPortTypeProxy" />
<%
...
case 10:
        gotMethod = true;
        br.com.ftm.exemplos.PrimeiroPortType getPrimeiroPortType10mtemp = samplePrimeiroPortTypeProxyid.getPrimeiroPortType();
