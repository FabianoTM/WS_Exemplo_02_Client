...
public class PrimeiroPortTypeProxy implements br.com.ftm.exemplos.PrimeiroPortType {
  private String _endpoint = null;
  private br.com.ftm.exemplos.PrimeiroPortType primeiroPortType = null;
  ...
  private void _initPrimeiroPortTypeProxy() {
    try {
      primeiroPortType = (new br.com.ftm.exemplos.PrimeiroLocator()).getPrimeiroHttpSoap11Endpoint();
  ...
  public br.com.ftm.exemplos.PrimeiroPortType getPrimeiroPortType() {
    if (primeiroPortType == null)
      _initPrimeiroPortTypeProxy();
